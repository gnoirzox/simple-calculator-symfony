...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CalculatorType' => function () {
    return ($this->privates['App\Form\CalculatorType'] ?? $this->privates['App\Form\CalculatorType'] = new \App\Form\CalculatorType());
